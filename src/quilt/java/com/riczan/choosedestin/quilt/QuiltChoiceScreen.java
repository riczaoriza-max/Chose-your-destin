...
public final class QuiltChoiceScreen extends Screen {
    private final String prompt;
    private final List<String> options;

    public QuiltChoiceScreen(String prompt, List<String> options) {
    ...
    private void sendSelection(int index) {
        ...
        buf.writeInt(index);
        ClientPlayNetworking.send(ChooseYourDestinQuilt.SELECT_CHOICE_PACKET, buf);
